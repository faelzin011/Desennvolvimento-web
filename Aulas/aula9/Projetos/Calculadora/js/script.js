...
criarBotao('btn-ponto', 'btn-calculo', '.')
criarBotao('btn-soma', 'btn-calculo', '+')
criarBotao('btn-sub', 'btn-calculo', '-')
criarBotao('btn-mult', 'btn-calculo', '*')
criarBotao('btn-div', 'btn-calculo', '/')
criarBotao('btn-result', 'btn-calculo', '=')
